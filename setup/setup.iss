...
Name: "{group}\PC0483"; IconFilename: "{app}\icon.ico"; Filename: "{app}\ExcelVideoLabeler.API.exe";
...
Name: "{commondesktop}\PC0483"; IconFilename: "{app}\icon.ico"; Filename: "{app}\ExcelVideoLabeler.API.exe"; Tasks: desktopicon;
